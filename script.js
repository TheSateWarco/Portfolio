$(document).ready(function () {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: "STEM Capstone is a year long project meant for seniors in highschool. I unknowingly enrolled for this class as a junior and completed the STEM honors a year ahead of my grade. <br><br> I started archery in 4th grade and was inspired to based my project on a common problem among archers, their form. My people have a hard time keeping a consistent form with each arrow they shoot. There are a couple devices that attempt to fix bad habits, but they all have their draw backs:<br><br>&emsp;Accubow: Good for practicing front arm stabalization, but not good for consistency<br><br>&emsp;Clicker: Good for draw consistency, but the user may be reliant on the sound rather than their form<br><br>My solution was a virtural simulation that tracks both the front and back arm. A phone could be attached to any bow and would show a view of a forest along with a side view of the user. A glove was placed on the user to sync with the arm of the human model. This will alow the user to see how their motions of the back arm will affect their form in real-time<br><br>I decided to pick this project back up 4 years later. Instead of making a simulation, I plan to make an app or website that will show statistical data on the accuracy of the hand placement. This will act similar to the physical clicker; however, I want the user to be able to use it without relying on a sound. This will be done using a laser distance measuring tool that will be placed on the back hand. I already programmed the measurement mechanic using a VL53L1X, but I have not figured out how I want to display the information.",
            status: "On-Hold",
            language: ["C++", "C#"],
